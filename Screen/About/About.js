...
export default function About() {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' , marginTop:75 }}>
            ...
            <Text style={{ color: 'white', fontSize: 12 , marginTop:5 , textAlign:'center' }}>follow islavo</Text>
        <View style={{ flexDirection: 'row', marginTop: 7, marginBottom: 1 }}>
            ...
            <Text style={{ color: 'white', fontSize: 12 , marginTop:5 , textAlign:'center' }}>email: islavo.info@gmail.com</Text>
            <Text style={{ color: 'white', fontSize: 12 , textAlign:'center' , alignItems:'center'   }}
        onPress = {() => navigation.navigate('Privecy')}> privacy policy for islavo </Text>
            <Text style={{ color: 'white', fontSize: 10 , marginTop:-0 , textAlign:'center' }}>©islavo</Text>
            <ShareExample/>
