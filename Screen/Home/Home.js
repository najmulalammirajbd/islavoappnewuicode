    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center'  }}>
          <Header/>
            ...
            <Pressable onPress = {() => navigation.navigate('Song')} style={{alignItems:'center',borderColor:'white',borderWidth:1,paddingTop:10,paddingBottom:10,marginRight:5,marginLeft:5,width:'45%' , marginBottom:7, flexDirection:'column', borderTopRightRadius:25 }} >
            <Ionicons name="md-musical-notes-outline" size={28} color="white" />
            <Text style={{ color: 'white', fontSize: 15}}>music</Text>
            </Pressable>
            <Pressable onPress = {() => navigation.navigate('SongPremium')} style={{alignItems:'center',borderColor:'white',borderWidth:1,paddingTop:10,paddingBottom:10,marginRight:5,marginLeft:5,width:'45%' , marginBottom:7, flexDirection:'column' , borderTopLeftRadius:25 }}>
            ...
            <Text style={{ color: 'white', fontSize: 15}}>islavo artist</Text>
            </Pressable>
            </View>
            <Pressable onPress = {() => navigation.navigate('About')} style={{alignItems:'center',paddingTop:5,paddingBottom:0,marginRight:20,marginLeft:20,width:'93%' , marginBottom:0 , borderRadius: 3}}>
